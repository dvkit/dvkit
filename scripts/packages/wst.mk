...
WST_VERSION = 3.10.0
WST_ZIP = wtp-repo-R-$(WST_VERSION)-20180611164516.zip
WST_URL = $(ECLIPSE_MIRROR_URL)/webtools/downloads/drops/R$(WST_VERSION)/R-$(WST_VERSION)-20180611164516/$(WST_ZIP)
