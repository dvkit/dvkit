...
f.WriteLine("      <Directory Id=\"ApplicationProgramsFolder\" Name=\"DVKit_$(var.version)\"/>\r\n");
f.WriteLine("    </Directory>\r\n");
f.WriteLine("    <Directory Id=\"$(var.ProgramFilesFolder)\" Name=\"PFiles\">");
f.WriteLine("      <Directory Id=\"DVKit\" Name=\"DVKit\">");
f.WriteLine("        <Directory Id=\"INSTALLDIR\" Name=\"DVKit_$(var.version)\">");
