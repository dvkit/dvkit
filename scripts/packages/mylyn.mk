...
MYLYN_VERSION = 3.25.0
MYLYN_DOCS_VERSION = 3.0.25
MYLYN_ZIP = mylyn-$(MYLYN_VERSION).v20180628-2143.zip
MYLYN_DOCS_ZIP = mylyn_docs-$(MYLYN_DOCS_VERSION).zip
MYLYN_URL = $(ECLIPSE_MIRROR_URL)/mylyn/drops/$(MYLYN_VERSION)/v20180628-2143/$(MYLYN_ZIP)
