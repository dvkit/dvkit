...
MYLYN_VERSION = 3.23.0
MYLYN_ZIP = mylyn-$(MYLYN_VERSION).v20170510-0304.zip
MYLYN_URL = $(ECLIPSE_MIRROR_URL)/mylyn/drops/$(MYLYN_VERSION)/v20170510-0304/$(MYLYN_ZIP)
...
MYLYN_FEATURES := org.eclipse.mylyn.feature.group
