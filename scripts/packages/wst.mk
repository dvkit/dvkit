...
WST_VERSION = 3.8.2
WST_ZIP = wtp-repo-R-$(WST_VERSION)-20170308000057.zip
WST_URL = $(ECLIPSE_MIRROR_URL)/webtools/downloads/drops/R$(WST_VERSION)/R-$(WST_VERSION)-20170308000057/$(WST_ZIP)
